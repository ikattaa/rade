* Contexte :
	...
	il est nécessaire d'utiliser deux batchs :
		...
		On utilise le fichier d'historique le plus récent fournit par l'INSEE avec en paramètre la date du 02/01/1999.
...
*** comsimp1999_avant_PEC_2021.txt :
	...
	Ce fichier peut être importé avec la date du 01/01/1999.
...
*** comsimp1999.txt : 
	...
	Dans le fichier de communes de 2021 les noms majuscules ne contiennent plus de caratères spéciaux
	contrairement au fichier de 1999. Nous avons donc corrigé le fichier de 1999 au niveau des caractères spéciaux
	des noms de 13931 communes supplémentaires.
